            ...
            <SectionHeader 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 details-wrapper">
                        <p class="lead description">{{ this.book.description }}</p>
                        <div mb-4>
                            <div class="row border-bottom pb-2">
                                <div class="col-lg-6"><strong>Page</strong></div>
                                <div class="col-lg-6">{{ this.book.page }}</div>
                            </div>
                            <div class="row border-bottom pb-2">
                            ...
                            <div class="row border-bottom pb-2">
                                ...
                                <div class="col-lg-6">{{ this.book.rating }}</div>
                            </div>
                            <div class="row border-bottom pb-2">
                                <div class="col-lg-6"><strong>Upload Date</strong></div>
                                <div class="col-lg-6">{{ this.book.uploadDate }}</div>
                            </div>
                        </div>
